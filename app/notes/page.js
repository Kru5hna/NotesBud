...
export default function NotesPage() {
    ...
    return (
        <main id="notes">
            ...
            {isViewer && (
                <Viewer savingNote={savingNote} handleSaveNote={handleSaveNote} handleToggleMenu={handleToggleMenu} text={note.content} isViewer={isViewer} handleToggleViewer={handleToggleViewer} />
            )}
        </main>
    )
}